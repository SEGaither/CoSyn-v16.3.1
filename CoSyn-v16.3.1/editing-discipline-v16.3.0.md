...
Task-specific bolt-ons MAY define domain-specific editing protocols that consume this Core editing discipline. Extensions:
...
- Package identity: `editing-discipline-v16.3.0`
- Required Core generation: 16.3.0
- Legacy compatibility: none with Editing_Preferences v1.x

---

*Document ID: editing-discipline-v16.3.0 — PROPOSED / UNDER REFINEMENT — Generated 2026-08-14*
