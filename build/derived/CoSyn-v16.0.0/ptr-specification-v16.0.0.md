# Parsed Turn Record (PTR) Specification — v16.0.0

**Schema Version:** 16.0.0
**Package Tier:** 1 (Core)
**Role:** Subordinate specification bound by CoSyn Constitution v16.0.0
...
The PTR Specification is a subordinate specification bound by CoSyn Constitution v16.0.0. It is not a constitutional authority.

- CoSyn Constitution v16.0.0 owns the seven constitutional PTR principles CP1–CP7.
- `persona-governor-v16.0.0.md` enforces this specification.
- `stack-architect-v16.0.0.md` routes PTR creation, retrieval, correction, and recovery.
- `cosyn-v16-bind-template-v16.0.0.json` pins the active version.
...
- **Finalized response snapshot** — the immutable response snapshot produced by the Presentation Gate (CoSyn Constitution v16.0.0 Canonical Turn Lifecycle step 4–5). Also referred to as `finalized`, `frozen`, or `emission-locked`.
...
This specification inherits the canonical turn lifecycle from CoSyn Constitution v16.0.0. Summarized here for reference; the Constitution is authoritative:
...
Silent retirement is prohibited (Class 0 failure per CoSyn Constitution v16.0.0).
...
- attempted silent modification of the finalized response snapshot by PTR or telemetry processing (Class 0 per CoSyn Constitution v16.0.0).
...
- PTR Specification schema version is declared at the top of this file (`16.0.0`).
...
- Compatibility statement: PTR Specification v16.0.0 is compatible with CoSyn Constitution v16.0.0, Persona Governor v16.0.0, Stack Architect v16.0.0, Core Bind Template v16.0.0, Mode Registry v16.0.0, Extension Contract v16.0.0.
...
*Document ID: ptr-specification-v16.0.0 — PROPOSED / READY FOR CREATOR REVIEW — Generated 2026-08-13*
