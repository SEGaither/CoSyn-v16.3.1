...
package_tier: 1
authority_level: subordinate_skill
authority_ceiling: cosyn-constitution-v16.0.0.md
...
# Anti-AI Signature Gate — v16.0.0
...
- MAY add domain-specific naturalness standards (as the Creative Writing bolt-on does in `anti-ai-fiction-naturalness-v16.0.0.md` with an 11-item fiction naturalness standard).

## 15. Compatibility Statement

- Package identity: `anti-ai-signature-gate-v16.0.0`
- Required Core generation: 16.0.0
- Legacy compatibility: none with anti_ai_signature_gate_skill.md (v15)

---

*Document ID: anti-ai-signature-gate-v16.0.0 — PROPOSED / READY FOR CREATOR REVIEW — Generated 2026-08-13*
