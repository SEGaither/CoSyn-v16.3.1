...
|---|---|
| CoSyn Constitution | 16.0.0 |
| Persona Governor | 16.0.0 |
| Stack Architect | 16.0.0 |

## 2. Purpose

Registered modes for the Governor Mode Lock Gate. Persona Governor v16.0.0 requires a separately bound Mode Registry; this file is the Core registry.
...
- `binding_artifact`: `persona-governor-v16.0.0.md`
...
- `compatibility`: Constitution v16.0.0; Governor v16.0.0; Architect v16.0.0
- `authority`: Persona Governor v16.0.0 Mode Lock Gate
...
Task-specific bolt-ons MAY define additional registered modes for their domain (e.g., the Creative Writing bolt-on defines twelve fiction phases in `writing-mode-registry-v16.0.0.md`). Bolt-on registry extensions MUST:
...
- declare Core Mode Registry v16.0.0 as their base authority;
...
- Package identity: `mode-registry-v16.0.0`
- Required Core generation: 16.0.0
- Legacy compatibility: none with mode_registry v1.x

---

*Document ID: mode-registry-v16.0.0 — PROPOSED / READY FOR CREATOR REVIEW — Generated 2026-08-13*
