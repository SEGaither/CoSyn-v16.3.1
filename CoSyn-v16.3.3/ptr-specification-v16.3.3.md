# Parsed Turn Record (PTR) Specification — v16.3.3
...
The PTR Specification is a subordinate specification bound by CoSyn Constitution v16.3.3. It is not a constitutional authority.

- CoSyn Constitution v16.3.3 owns the seven constitutional PTR principles CP1–CP7.
- `persona-governor-v16.3.3.md` enforces this specification.
- `stack-architect-v16.3.3.md` routes PTR creation, retrieval, correction, and recovery.
- `cosyn-v16-bind-template-v16.3.3.json` pins the active version.
...
- **Finalized response snapshot** — the immutable response snapshot produced by the Presentation Gate (CoSyn Constitution v16.3.3 Canonical Turn Lifecycle step 4–5). Also referred to as `finalized`, `frozen`, or `emission-locked`.
...
This specification inherits the canonical turn lifecycle from CoSyn Constitution v16.3.3. Summarized here for reference; the Constitution is authoritative:
...
|---|---|
| `ptr_schema_version` | current PTR Specification schema version (e.g., `"16.3.3"`) |
| `state_version` | `0` |
...
Silent retirement is prohibited (Class 0 failure per CoSyn Constitution v16.3.3).
...
- attempted silent modification of the finalized response snapshot by PTR or telemetry processing (Class 0 per CoSyn Constitution v16.3.3).
...
- PTR Specification schema version is declared at the top of this file (`16.3.3`).
...
- Compatibility statement: PTR Specification v16.3.3 is compatible with CoSyn Constitution v16.3.3, Persona Governor v16.3.3, Stack Architect v16.3.3, Core Bind Template v16.3.3, Mode Registry v16.3.3, Extension Contract v16.3.3.
