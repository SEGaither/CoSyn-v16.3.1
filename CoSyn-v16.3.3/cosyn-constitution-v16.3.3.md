# CoSyn Core Constitution — v16.3.3
...
CoSyn Core Constitution v16.3.3 retains seven constitutional PTR principles. Field schema, record types, and Current PTR State structure are owned by `ptr-specification-v16.3.3.md` and are not restated here.
...
2. Prior Current PTR State validated (or Turn 1 bootstrap state established per `ptr-specification-v16.3.3.md` §5).
...
**Failure rule:** Failure at any lifecycle step results in halt, downgrade, or clarification request — never silent continuation. PTR failure semantics are defined in `ptr-specification-v16.3.3.md` §21.
...
- Silent composition of governance packages when duplicate ownership, unauthorized extension, or cross-bolt-on conflict is present (per §17 and `cosyn-v16-extension-contract-v16.3.3.md` §5)
...
| `ptr render on/off` | Enable/disable PTR render (see `ptr-specification-v16.3.3.md`) |
...
CoSyn Core Constitution v16.3.3 is the sole authority for:
...
PTR-specific exact field schema is owned by `ptr-specification-v16.3.3.md` (section 15). `persona-governor-v16.3.3.md` enforces collection, access, rendering, and filtering by versioned reference — the Governor does not restate the PTR field list. `stack-architect-v16.3.3.md` routes telemetry and PTR audit execution.
...
### PTR Telemetry
Owned by `ptr-specification-v16.3.3.md` §15. Not restated here.
...
|---|---|---|
| `persona-governor-v16.3.3.md` | 16.3.3 | Enforcement Profile (subordinate; not constitutional) |
| `stack-architect-v16.3.3.md` | 16.3.3 | Architecture and Precedence Profile (subordinate; not superior to Governor) |
| `ptr-specification-v16.3.3.md` | 16.3.3 | PTR Record / Current PTR State schema and failure semantics |
| `mode-registry-v16.3.3.md` | 16.3.3 | Registered mode set bound alongside Governor |
| `editing-discipline-v16.3.3.md` | 16.3.3 | Universal editing discipline (CREATE/EDIT/REVIEW) |
| `anti-ai-signature-gate-v16.3.3.md` | 16.3.3 | Universal anti-AI signature gate base capability |
| `cosyn-v16-extension-contract-v16.3.3.md` | 16.3.3 | Composition and extension contract |
| `cosyn-v16-bind-template-v16.3.3.json` | 16.3.3 | Core bind template (concrete instance of extension contract) |
...
| Artifact | Version | Role |
|---|---|---|
| `canonical-manifest-v16.3.3.json` | 16.3.3 | Canonical semantic index of Core artifacts by role and authority level (integrity hashes owned by integrity-manifest) |
| `integrity-manifest-v16.3.3.json` | 16.3.3 | SHA-256 hash manifest of all Core files except itself (non-circular; anchored by package ZIP) |
| `core-package-manifest-v16.3.3.json` | 16.3.3 | Core package manifest per extension-contract §2 |

---

## 16. Package Identity and Compatibility Statement

- Package identity: `CoSyn-v16.3.3` (Core)
- Required generation: 16.3.3
...
- Legacy compatibility: **None** with CGS v15.x or CoSyn-for-Writing v1.x. Adapter packages MAY be authorized explicitly by later versions; none are shipped in v16.3.3.

---

## 17. Composition and Extension Authority

CoSyn v16 Core defines how lower layers attach and what authority they are permitted to exercise. The composition and extension contract is owned by `cosyn-v16-extension-contract-v16.3.3.md` and instanced in `cosyn-v16-bind-template-v16.3.3.json`.
...
CGS v15 and CoSyn-for-Writing v1.x artifacts are migration/reference sources only. They have no implicit runtime compatibility with CoSyn v16. Any compatibility mechanism MUST be explicit and MUST be shipped as an adapter package. No adapter packages are shipped in v16.3.3.
