...
|---|---|
| CoSyn Constitution | 16.3.3 |
| Persona Governor | 16.3.3 |
| Stack Architect | 16.3.3 |

## 2. Purpose

Registered modes for the Governor Mode Lock Gate. Persona Governor v16.3.3 requires a separately bound Mode Registry; this file is the Core registry.
...
- `binding_artifact`: `persona-governor-v16.3.3.md`
...
- `compatibility`: Constitution v16.3.3; Governor v16.3.3; Architect v16.3.3
- `authority`: Persona Governor v16.3.3 Mode Lock Gate
...
- declare Core Mode Registry v16.3.3 as their base authority;
...
- Package identity: `mode-registry-v16.3.3`
- Required Core generation: 16.3.3
- Legacy compatibility: none with mode_registry v1.x

---

*Document ID: mode-registry-v16.3.3 — RATIFIED / CANONICAL — ratified 2026-08-16 — Generated 2026-08-15*
