...
schema_version: 16.2.0
package_tier: 1
authority_level: subordinate_discipline
authority_ceiling: cosyn-constitution-v16.2.0.md
...
refined_from: anti-ai-signature-gate-v16.1.0.md (SHA-256 9D68BAC3CE08180306CAA715F573F63B9BEBB2185B646EEAA9140EE7D8BC8181) — corrective refinement per Creator-authorized CCT pass
generated: 2026-08-14
---

# Anti-AI Signature Gate — v16.2.0
...
**v16.1.0 → v16.2.0 Corrective Refinement (D07):** Replaced exact task-specific bolt-on filename reference in §14 with a capability-family reference, eliminating a stale-reference trap as the bolt-on's naturalness extension may increment version.
...
This artifact is the Core-owned base capability. Task-specific bolt-ons MAY extend the gate's application scope to their domain by declaring `capabilities_extended` targeting `anti-ai-signature-gate.base-detection-and-rewrite`. Extensions do not fork the base gate; they declare dependency and add scope-specific handling only.
...
Task-specific bolt-ons MAY extend the application scope of this gate by declaring `capabilities_extended` targeting `anti-ai-signature-gate.base-detection-and-rewrite`. Extensions:
...
- MAY add domain-specific naturalness standards appropriate to their applicability scope (e.g., a creative writing bolt-on may define a fiction naturalness standard targeting prose naturalness in fiction contexts).

## 15. Compatibility Statement

- Package identity: `anti-ai-signature-gate-v16.2.0`
- Required Core generation: 16.2.0
- Legacy compatibility: none with anti_ai_signature_gate_skill.md (v15)

---

*Document ID: anti-ai-signature-gate-v16.2.0 — PROPOSED / UNDER REFINEMENT — Generated 2026-08-14*
