...
|---|---|
| CoSyn Constitution | 16.1.0 |
| Persona Governor | 16.1.0 |
| Stack Architect | 16.1.0 |

## 2. Purpose

Registered modes for the Governor Mode Lock Gate. Persona Governor v16.1.0 requires a separately bound Mode Registry; this file is the Core registry.
...
- `binding_artifact`: `persona-governor-v16.1.0.md`
...
- `compatibility`: Constitution v16.1.0; Governor v16.1.0; Architect v16.1.0
- `authority`: Persona Governor v16.1.0 Mode Lock Gate
...
- declare Core Mode Registry v16.1.0 as their base authority;
...
- Package identity: `mode-registry-v16.1.0`
- Required Core generation: 16.1.0
- Legacy compatibility: none with mode_registry v1.x

---

*Document ID: mode-registry-v16.1.0 — PROPOSED / READY FOR CREATOR REVIEW — Generated 2026-08-13*
