...
5. Subordinate specifications named by Constitution (`ptr-specification-v16.3.0.md`)
6. Protocols and gates named by Constitution
7. `mode-registry-v16.3.0.md` (bound alongside Governor)
8. Bound Core subordinate discipline artifacts (`editing-discipline-v16.3.0.md`, `anti-ai-signature-gate-v16.3.0.md`, `cosyn-v16-extension-contract-v16.3.0.md`)
